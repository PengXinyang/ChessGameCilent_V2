...
public abstract class ChessStats extends Rectangle {
    ...
    public ChessStats(int cid,int x, int y, Integer color,String chessName) {
    ...
    public ResponseResult moveChess(int dstX, int dstY) throws CanNotMoveToException{
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                String uri = String.format("http://localhost:8081/move/chess?cid=%d&x=%d&y=%d", cid, dstX, dstY);
